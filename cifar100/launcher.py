...
EXP_SPEC = "{algorithm}_data={data}_n={n}_K={K}_Kgen={K_gen}_lr={lr:.3e}_m={momentum:.2f}_v={validation_batch_size}_noniid={noniid}_ms={model_size}_ss={subsample_ratio}_vggtype={model_type}"
