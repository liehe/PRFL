...
def define_parser():
    ...
    ### Byzantine related
    parser.add_argument("--b", type=int, default=0, help="Byzantine")
    parser.add_argument("--byz-kind", type=str, default=None, help="Gaussian/...")
...
class TrainMeter(object):
    ...
    def add(self, worker_results):
        worker_results = [res for res in worker_results if res is not None]
